 ...
 * @author luke
 */
class FullCalendarCustom extends JsWidget
{
    ...
    public function init()
    {
        ...
        if($this->contentContainer) {
            $this->editUrl = $this->contentContainer->createUrl('/calendar/entrycustom/edit', ['cal' => true]);
            $this->dropUrl = $this->contentContainer->createUrl('/calendar/entrycustom/edit-ajax');
        }
