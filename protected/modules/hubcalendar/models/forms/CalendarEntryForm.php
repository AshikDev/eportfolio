...
namespace humhub\modules\hubcalendar\models\forms;

use DateTime;
use humhub\modules\hubcalendar\models\reminder\forms\ReminderSettings;
use Yii;
use yii\base\Exception;
use yii\base\Model;
use DateTimeZone;
use humhub\modules\hubcalendar\interfaces\recurrence\RecurrenceFormModel;
use humhub\modules\hubcalendar\models\forms\validators\CalendarDateFormatValidator;
use humhub\modules\hubcalendar\models\forms\validators\CalendarEndDateValidator;
use humhub\modules\hubcalendar\models\forms\validators\CalendarTypeValidator;
...
class CalendarEntryForm extends Model
{
    ...
    /**
     * @var string timeZone set in hubcalendar form
     */
    public $timeZone;

    /**
     * @var int hubcalendar event type id
     */
    public $type_id;
