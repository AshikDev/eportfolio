...
class SnippetModuleSettings extends Model
{
    ...
    /**
     * @var boolean determines if the hubcalendar top menu item adn dashboard widget should only be shown if the user installed the hubcalendar module in his profile
     */
    ...
    {
        return !self::instantiate()->showIfInstalled || (!Yii::$app->user->isGuest && Yii::$app->user->getIdentity()->isModuleEnabled('hubcalendar'));
    }
