...
namespace humhub\modules\hubcalendar\models;

use humhub\modules\hubcalendar\helpers\RecurrenceHelper;
use humhub\modules\hubcalendar\interfaces\event\CalendarEntryTypeSetting;
use humhub\modules\hubcalendar\interfaces\fullcalendar\FullCalendarEventIF;
use humhub\modules\hubcalendar\interfaces\participation\CalendarEventParticipationIF;
...
use humhub\modules\hubcalendar\models\participation\CalendarEntryParticipation;
use humhub\modules\hubcalendar\models\recurrence\CalendarEntryRecurrenceQuery;
...
use humhub\modules\hubcalendar\interfaces\event\CalendarEventStatusIF;
use humhub\modules\hubcalendar\notifications\CanceledEvent;
use humhub\modules\hubcalendar\notifications\ReopenedEvent;
use humhub\modules\hubcalendar\permissions\ManageEntry;
use humhub\modules\hubcalendar\widgets\WallEntry;
    ...
    CalendarEventStatusIF, CalendarEventReminderIF, CalendarEventParticipationIF
{
    ...
    /**
     * Removes the hubcalendar entry type.
     * @param $type
     */
