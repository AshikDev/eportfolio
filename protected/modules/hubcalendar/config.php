...
use humhub\modules\hubcalendar\Events;
...
return [
    'id' => 'hubcalendar',
    'class' => 'humhub\modules\hubcalendar\Module',
    ...
    'events' => [
        ...
        ['class' => 'humhub\modules\hubcalendar\interfaces\CalendarService', 'event' => 'getItemTypes', 'callback' => [Events::class, 'onGetCalendarItemTypes']],
        ['class' => 'humhub\modules\hubcalendar\interfaces\CalendarService', 'event' => 'findItems', 'callback' => [Events::class, 'onFindCalendarItems']],
