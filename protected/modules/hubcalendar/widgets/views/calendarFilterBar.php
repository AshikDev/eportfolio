...
use humhub\modules\hubcalendar\widgets\CalendarControls;
use humhub\modules\hubcalendar\widgets\ConfigureButton;
                ...
                <div style="text-align: right;">
                    <ul style="list-style: none;">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu custom_menu" style="text-decoration: none; min-width: 280px;">
