...
use humhub\modules\hubcalendar\assets\CalendarAsset;
...
class FullCalendar extends JsWidget
{
    ...
    public function init()
    {
        ...
        // Used by the global hubcalendar if the module is not enabled for the given user.
        if($this->contentContainer && !$this->contentContainer->isModuleEnabled('hubcalendar')) {
            $this->enabled = false;
        }
