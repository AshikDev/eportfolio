...
namespace humhub\modules\hubcalendar\interfaces\recurrence\widgets;


use humhub\modules\hubcalendar\assets\RecurrenceFormAssets;
...
class RecurrenceFormWidget extends JsWidget
{
    ...
    public function run()
    {
        ...
        return $this->render('@hubcalendar/views/common/recurrenceForm', [
            'model' => $model,
            'form' => $this->form,
