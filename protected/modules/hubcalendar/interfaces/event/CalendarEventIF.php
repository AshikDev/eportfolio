...
/**
 * This interface serves as the base interface for all types of hubcalendar events.
 *
 * ## UID
 *
 * The uid of an event can be accessed by [[getUid()]]. The module related to the event type can either
 * manually assign a UID, or let the hubcalendar assign a uid which requires the event model to implement
 * [[EditableEventIF]].
 *
 * ## Date ranges
 *
 ...
 * ## Calendar View
 *
 * The following functions defines how the event is handled within the hubcalendar:
 *
