...
/**
 * In order to use some hubcalendar interfaces events need to be updated or even deleted. Event types facilitating
 * such interfaces need to implement the EditableEventIF.
 *
 * @package humhub\modules\hubcalendar\interfaces\event
 */
interface EditableEventIF extends CalendarEventIF
{
     ...
     *
     * The hubcalendar interface increments the sequence automatically when an EditableEventIF content entry is saved
