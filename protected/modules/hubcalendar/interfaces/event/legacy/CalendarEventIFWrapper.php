...
namespace humhub\modules\hubcalendar\interfaces\event\legacy;
 ...
 * @deprecated Used for deprecated array based hubcalendar interface (prior to v1.0.0)
 */
class CalendarEventIFWrapper extends Model implements CalendarEventIF, FullCalendarEventIF
{
     ...
     * `isUpdatable()` hubcalendar view updates should be supported.
     *
