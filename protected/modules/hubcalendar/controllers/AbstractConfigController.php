...
use humhub\modules\hubcalendar\interfaces\event\CalendarTypeSetting;
use humhub\modules\hubcalendar\models\participation\ParticipationSettings;
use Yii;
...
use humhub\modules\hubcalendar\models\DefaultSettings;
...
{
    const VIEW_CONFIG_DEFAULT = '@hubcalendar/views/common/defaultConfig';
    const VIEW_CONFIG_TYPE = '@hubcalendar/views/common/typesConfig';
    const VIEW_CONFIG_EDIT_TYPE_MODAL = '@hubcalendar/views/common/editTypeModal';
    const VIEW_CONFIG_CALENDARS = '@hubcalendar/views/common/calendarsConfig';
