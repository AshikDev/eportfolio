...
/**
 * EntryController used to display, edit or delete hubcalendar entries
 *
...
class EntryController extends ContentContainerController
{
    ...
    /**
     *
     * @param null $id hubcalendar entry id
     ...
     * @param null $cal whether or not the edit event came from the hubcalendar view
     * @return string
     * @throws HttpException
     * @throws Throwable
     * @throws Exception
    ...
    /**
     * Returns a readable hubcalendar entry by given id
     *
     * @param int $id
