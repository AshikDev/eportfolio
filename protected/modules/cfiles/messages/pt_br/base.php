...
return array (
  ...
  '<strong>Note:</strong> The replacement behaviour is currently not supported for zip imports.' => '<strong> Observação: </ strong> o comportamento de substituição não é suportado atualmente para importações de zip.',
  ...
  'Replace existing files' => 'Substituir arquivos existentes',
  'Root' => 'Raiz',
  ...
  'Updated' => 'Atualizado',
  'Upload behaviour for existing file names' => 'Upload de comportamento para nomes de arquivos existentes',
  ...
  'Use of file indexes for already existing files' => 'Uso de índices de arquivos para arquivos já existentes',
