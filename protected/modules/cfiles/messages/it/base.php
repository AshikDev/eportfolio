...
return array (
  ...
  '<strong>Note:</strong> The replacement behaviour is currently not supported for zip imports.' => '<strong>Nota:</strong> Il comportamento di sostituzione non è attualmente supportato per i caricamenti da file zip',
  ...
  'Replace existing files' => 'Sostituisci i file esistenti',
  'Root' => 'Root',
  ...
  'Updated' => 'Aggiornato',
  'Upload behaviour for existing file names' => 'Comportamento per il caricamento di nomi file già esistenti.',
  ...
  'Use of file indexes for already existing files' => 'Usa gli indici dei file per i file già esistenti.',
