...
<div class="panel panel-default panel-profile">
    ...
    <div class="panel-profile-header">
        ...
        <div class="image-upload-container" style="width: 100%; height: 100%; overflow:hidden;">
            ...
            <div class="img-profile-data" style="padding-left: 30px; padding-top: 2px;">
                <h1 class="space" style="font-size: 56px;"><?= Html::encode($space->name); ?></h1>
                <h2 class="space" style="font-size: 20px;"><?= Html::encode($space->description); ?></h2>
            </div>
    ...
    <div class="panel-body">
        ...
        <div class="panel-profile-controls" style="padding-left: 4px">
            <div class="row">
                <div class="col-md-12">
